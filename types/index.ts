...
export type ModelVariant =
  | 'ollama__deepseek-v3.1:671b-cloud'
  | 'ollama__gpt-oss:20b-cloud'
  | 'ollama__gpt-oss:120b-cloud'
  | 'ollama__kimi-k2:1t-cloud'
  | 'ollama__qwen3-coder:480b-cloud'
  | 'ollama__glm-4.6:cloud'
  | 'ollama__minimax-m2:cloud'
